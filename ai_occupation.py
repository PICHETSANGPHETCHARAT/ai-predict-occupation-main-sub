...
async def predict_main_occupation_with_gpt(job_title, main_occupation_list):
    ...
    try:
        ...
        5. หากตำแหน่งมีลักษณะงานแบบลงมือปฏิบัติจริงโดยใช้เครื่องมือหรือเครื่องจักร และอยู่ในระดับผู้ปฏิบัติงาน ให้พิจารณาอยู่ในหมวด "ช่าง/ช่างเทคนิค/อิเลคโทรนิค" มากกว่า "การผลิต/QA-QC"
        6. หากเป็นงานที่เกี่ยวข้องหลายสาย ให้พิจารณาหน้าที่หลักเป็นตัวตัดสิน
        7. หากตำแหน่งมีบทบาทหลักใน “การขาย” แม้จะมีความรู้ด้านเทคนิค ให้จัดอยู่ในหมวด “ขาย”
